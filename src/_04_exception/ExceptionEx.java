...
// 예외
// - 일반 예외 (Exception) : 컴파일러가 예외 처리 코드 여부를 검사하는 예외 코드
// - 실행 예외 (Runtime Exception) : 컴파일러가 예외 처리 코드 여부를 검사하지 않는 예외 코드

// => Java는 예외가 발생하는 예외 클래스로부터 객체 생성하며, 해당 객체는 예외 처리시 사용됨.
// 예외 발생 시 프로그램의 갑작스러운 종료를 막고 정상 실행할 수 있도록 처리하는 코드를 예외 처리 코드라고 함.
// try-catch-finally 블록으로 처리하면 된다!

// try 블록에서 작성한 코드가 예외 없이 정상 실행 -> catch 실행 x, finally 실행o
// try 블록에서 작성한 코드에서 예외 발생 -> catch 실행 o, finally 실행 o
// 심지어 try 블록과 catch 블록에서 return 문을 사용해도 finally 는 항상 실행됨! (그래서 finally 생략 가능!!)
...
public class ExceptionEx {
    ...
    public static void main(String[] args) {
        // case 1. 예외 발생 코드
//        System.out.println(divide(6,0)); // java.lang.ArithmeticException 에러 발생
        ...
        try {
            ...
            // 예외 출력 방법
            // 방법 1: 예외 발생한 이유만 보여줌
            System.out.println("나누기 중 에러 발생 >> " + e.getMessage()); // 출력값 : / by zero

            // 방법 2: 예외 종류 리턴
            System.out.println("나누기 중 에러 발생 >> " + e.toString()); // 출력값 : java.lang.ArithmeticException: / by zero
...
//            at _04_exception.ExceptionEx.main(ExceptionEx.java:32)
        ...
        ////////////////////////////////////////////
        // case 2. 예외 발생 코드
        // System.out.println("단어 길이 : " + getLength(null)); // NullPointerException 에러 발생
        ...
        try {
            ...
            // 출력값 : java.lang.NullPointerException: Cannot invoke "String.length()" because "str" is null
        }
...
//        System.out.println(getValueByIdx(numbers, numbers.length)); // ArrayIndexOutOfBoundsException 에러 발생
        ...
        try {
            ...
            // 출력값 : java.lang.ArrayIndexOutOfBoundsException: Index 5 out of bounds for length 5
        }
